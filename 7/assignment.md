...
When the user writes a task in the input field and clicks the add button, the task shall be added to the empty list with a checkbox in front of it. Make a JavaScript functions named "addTask()" that does this. Place the newest task on the top of the list.
